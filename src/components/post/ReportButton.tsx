...
interface ReportButtonProps {
  ...
  targetId: string;
  className?: string;
  variant?: "primary" | "secondary" | "ghost" | "ghostDark" | "accent" | "danger" | "menu";
    ...
    return (
      <>
        <button
          ...
          disabled={isChecking}
          className={cn(
            "flex items-center gap-3 px-4 py-3 text-sm text-rose-400 hover:bg-white/5 hover:text-rose-300 transition-colors w-full text-left disabled:opacity-50",
            className
          )}
        >
          {isChecking ? (
