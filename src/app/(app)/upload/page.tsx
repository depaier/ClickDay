      ...
      <div className={authLoading ? "hidden" : "block"}>
        ...
        {!previewUrl ? (
          <div
            ...
            className={`bg-[#111] border border-dashed rounded-sm p-12 flex flex-col items-center justify-center text-center cursor-pointer transition-all mb-8 ${isDragging ? "border-[var(--accent)] bg-[#151515]" : "border-gray-600 hover:border-gray-400"
              }`}
          >
            <input
              type="file"
