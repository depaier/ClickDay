          ...
          <div className="space-y-6">
            {!previewUrl ? (
              <div
                ...
                className={`bg-[#111] border border-dashed rounded-sm aspect-[4/5] flex flex-col items-center justify-center text-center cursor-pointer transition-all ${isDragging ? "border-[var(--accent)] bg-[#151515]" : "border-gray-600 hover:border-gray-400"
                  }`}
              >
                <input
                  type="file"
              ...
              <div className="sticky top-24">
                <div className="relative aspect-[4/5] w-full bg-[#111] rounded-sm overflow-hidden group border border-white/5">
                  <img src={previewUrl} alt="Preview" className="w-full h-full object-contain" />
                  <button
                    onClick={resetUpload}
                    className="absolute top-4 right-4 p-2 bg-black/50 hover:bg-black/80 rounded-full text-white transition-colors opacity-0 group-hover:opacity-100"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
