export const translations = {
  en: {
    ...
    onboarding: {
      ...
      termsDesc: "I agree to the community guidelines and terms of use as a photo sharing platform.",
      ...
      identitySubtitle: "Choose a nickname to use in the community.",
