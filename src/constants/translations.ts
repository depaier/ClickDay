export const translations = {
  en: {
    ...
    authGate: {
      ...
      feedSubtitle: "Join ClickDay to discover more hidden spots.",
    ...
    post: {
      ...
      editSubtitle: "Update your photography details and location.",
      editSuccess: "Post updated successfully!",
      editError: "Failed to update post.",
      updating: "Updating...",
      clickToChangeLoc: "Click to change location",
    },
    map: {
    ...
    settings: {
      ...
      displayNamePlaceholder: "Your name (shown on profile)",
      usernameHint: "Used in your profile URL. English, numbers, _ and . only.",
    ...
    onboarding: {
      welcome: "Welcome to ClickDay",
      welcomeSubtitle: "Please agree to our terms before starting.",
      termsTitle: "Terms of Service",
      termsDesc: "I agree to the service guidelines and terms of use as a photo sharing platform.",
      privacyTitle: "Privacy Policy",
      privacyDesc: "I agree to the collection of data and privacy policy for location-based services.",
      agreeAll: "I have read and agree to all of the above.",
      identityTitle: "Set Identity",
      identitySubtitle: "Choose a nickname to use on ClickDay.",
      nicknameLabel: "Username (2-15 characters)",
      nicknamePlaceholder: "e.g. john_doe",
      nicknameHint: "English letters, numbers, underscores (_) and periods (.) only.",
      nicknameTaken: "Taken",
      discoveryTitle: "Discovery",
      discoverySubtitle: "Tell us what kind of photos you like.",
      landscape: "Landscape",
      street: "Street",
      portrait: "Portrait",
  ...
  ko: {
    ...
    post: {
      ...
      editSubtitle: "사진 상세 정보와 위치를 수정합니다.",
      editSuccess: "게시물이 성공적으로 수정되었습니다.",
      editError: "게시물 수정에 실패했습니다.",
      updating: "수정 중...",
      clickToChangeLoc: "클릭하여 위치 변경",
    },
    map: {
      initializing: "지도를 불러오는 중",
      clickToPick: "지도를 클릭하여 위치 선택",
      searchPlace: "장소 검색...",
    },
    settings: {
      ...
      displayNameLabel: "이름",
      displayNamePlaceholder: "프로필에 표시될 이름",
      usernameHint: "프로필 URL에 사용됩니다. 영문, 숫자, _, . 만 사용 가능합니다.",
      bioPlaceholder: "자신을 소개해 주세요...",
      usernamePlaceholder: "예: john_doe",
    ...
    onboarding: {
      welcome: "ClickDay에 오신 것을 환영합니다",
      welcomeSubtitle: "시작하기 전에 서비스 이용 정책에 동의해주세요.",
      termsTitle: "서비스 이용 약관",
      termsDesc: "서비스 가이드라인 및 사진 공유 플랫폼으로서의 이용 정책을 준수함에 동의합니다.",
      privacyTitle: "개인정보 처리방침",
      privacyDesc: "위치 정보 기반 서비스 제공을 위한 데이터 수집 및 개인정보 처리 방침에 동의합니다.",
      agreeAll: "위 내용을 모두 확인했으며 동의합니다.",
      identityTitle: "정체성 설정",
      identitySubtitle: "ClickDay에서 활동할 닉네임을 설정해주세요.",
      nicknameLabel: "사용자 아이디 (2~15자)",
      nicknamePlaceholder: "예: john_doe",
      nicknameHint: "영문, 숫자, 언더바(_), 마침표(.)만 사용 가능합니다.",
      nicknameTaken: "사용 불가",
      discoveryTitle: "취향 발견",
      discoverySubtitle: "어떤 스타일의 사진을 선호하시나요?",
      landscape: "풍경",
      street: "거리",
      portrait: "인물",
      architecture: "건축",
